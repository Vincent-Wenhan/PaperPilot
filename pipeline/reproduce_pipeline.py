...
def _legacy_run_reproduce_pipeline(
    pdf_path: str,
    github_url: str = "",
    ...
    automatically. When ``paper_name`` is provided, output files are written to
    ...
    _save_outputs(result, repo_scan or generated_repo_scan, diagnosis_text, output_dir=output_dir)
